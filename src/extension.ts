...
import { findActiveSession, parseSessionFile, listSessions, calcDailySpend } from './parser';
...
export function activate(context: vscode.ExtensionContext) {
  ...
  context.subscriptions.push(
    ...
    vscode.commands.registerCommand('claudeCodeHud.switchSession', (filePath: string) => {
...
function buildMockStats(cfg: Config) {
  return {
